...
public class UserWebSocketStarter extends WebSocketAdapter implements WebSocketStarter {
    ...
    public UserWebSocketStarter(String host, Integer port, String userToken, String userAgent, UserMessageListener userMessageListener, DiscordHelper discordHelper) {
        initProxy(host, port);
        this.host = host;
        this.port = port;
